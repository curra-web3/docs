...
- [What is Curra?](obsidian/intoduction/what_is_curra.md)
- [Availability](obsidian/intoduction/availability.md)

# Costs

- [Gas pump](obsidian/costs/gas_pump.md)
- [API pricing](obsidian/costs/api_pricing.md)

# Security

- [Protocol](obsidian/security/protocol.md)
- [Ownership NFT](obsidian/security/ownership_nft.md)
- [Authorization](obsidian/security/authorization/index.md)
  - [API](obsidian/security/authorization/api.md)
  - [Notifications](obsidian/security/authorization/notifications.md)
